...
const toggleClass =
  "cursor-pointer rounded-lg border border-black/20 px-4 py-2 text-center text-sm has-[:checked]:border-primary has-[:checked]:bg-primary has-[:checked]:text-primary-foreground";
